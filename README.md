...
| 读者 | 阅读顺序 | 时间预算 |
| --- | --- | --- |
| **业务 / 产品** | `需求分析.md`(全文) | 2-3 h |
| **后端开发** | `技术规格.md` → `db/`(各服务对应文件) → `api/`(各服务对应文件) → `cross-reference.md` | 6-8 h |
| **前端开发**(小程序) | `需求分析.md § 5/6/11` → `技术规格.md § 6/7/12` → `api/user.md` | 3-4 h |
| **前端开发**(PC 后台) | `需求分析.md § 7-10` → `技术规格.md § 3.3/7` → `api/admin.md` | 4-5 h |
| **测试 / QA** | `需求分析.md` → `api/`(按场景端点对) → `技术规格.md § 13` | 3-4 h |
| **运维** | `技术规格.md § 9-12` → `examples/` | 2-3 h |
| **AI 协作者**(自动开发) | `技术规格.md § 1/2/3/7` → `api/对应服务.md` → `db/对应服务.md` → `cross-reference.md` | 1-2 h(上下文压缩后) |
